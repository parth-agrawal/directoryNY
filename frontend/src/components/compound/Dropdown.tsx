...
const Dropdown: React.FC<DropdownProps> = ({ options, onSelect, defaultOption }) => {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left w-full">
            <div className="">
                <MenuButton className="inline-flex w-full justify-between items-center gap-x-1.5 rounded-md bg-[#FFFDF3] px-3 py-2 text-sm font-semibold text-gray-800 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
